//===================== (Neverway 2025) Written by Liz M. =====================
//
...
public class Screenshot : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKey(KeyCode.LeftAlt) && Input.GetKeyDown(KeyCode.C) || Input.GetKeyDown(KeyCode.F12))
        {
    ...
    IEnumerator TakeScreenShot()
    {
        ...
        Debug.Log("Captured screenshot: " + file);
